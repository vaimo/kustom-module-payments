...
class FixedTest extends RequestBuilderTestCase
{
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
        ...
        $this->prePurchaseValidator->performAllGeneralUsChecks($request, $quote, ['skip_product_total_check']);
    }
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnStoreLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnDefaultLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnStoreLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnDefaultLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnStoreLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
    ...
    public function testCouponLowerGrandTotalOnDefaultLevelForShopSetup4()
    {
        ...
        static::assertEquals(57, $fullTotalTaxAmount);
        static::assertEquals(57, $orderTaxAmount);
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnDefaultLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testCouponGreaterGrandTotalOnStoreLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
