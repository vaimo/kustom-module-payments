 ...
 * @internal
 */
class BundledDynamicTest extends RequestBuilderTestCase
{
    ...
    public function testSingleProductOnDefaultLevelForShopSetup1()
    {
        ...
        $this->quotePreparer->addProduct($quote, 'bundle-product-dynamic', 1);
    ...
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product-dynamic', 5);
