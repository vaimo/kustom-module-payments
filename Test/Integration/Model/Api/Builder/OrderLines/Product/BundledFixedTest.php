...
class BundledFixedTest extends RequestBuilderTestCase
{
     ...
     */
    public function testSingleProductOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnStoreLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnDefaultLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        ...
        $this->prePurchaseValidator->hasEachOrderlineItemNonZeroTaxAmount($request);
    }
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnStoreLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoConfigFixture current_store currency/options/allow GBP
     *
     * @magentoConfigFixture current_store tax/classes/shipping_tax_class 2
     *
     * @magentoConfigFixture current_store payment/klarna_kp/active 1
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnDefaultLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnStoreLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnStoreLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnDefaultLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnStoreLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnDefaultLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnStoreLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnDefaultLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSingleProductOnStoreLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnDefaultLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleDifferentProductsOnStoreLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 1);
        $this->quotePreparer->addProduct($quote, 'bundle-product-two', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSeveralProductsOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 5);
     ...
     * @magentoAppIsolation enabled
     */
    public function testSeveralProductsOnStoreLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'bundle-product', 5);
