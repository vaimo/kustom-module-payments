 ...
 * @internal
 */
class ConfigurableTest extends RequestBuilderTestCase
{
    ...
    public function testSingleProductOnDefaultLevelForShopSetup1()
    {
        ...
        $this->quotePreparer->addProduct($quote, 'configurable', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnStoreLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnDefaultLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnStoreLevelForShopSetup2()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnDefaultLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnStoreLevelForShopSetup3()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testProductIsTypeDigitalInOrderlineListOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 1);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnDefaultLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testMultipleProductsOnStoreLevelForShopSetup4()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'configurable', 2);
