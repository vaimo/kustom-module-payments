 ...
 * @internal
 */
class DownloadableTest extends RequestBuilderTestCase
{
    ...
    public function testSingleProductOnDefaultLevelForShopSetup1()
    {
        ...
        $this->quotePreparer->addProduct($quote, 'downloadable', 1);
    ...
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'downloadable', 2);
