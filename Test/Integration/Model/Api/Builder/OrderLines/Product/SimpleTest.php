...
class SimpleTest extends RequestBuilderTestCase
{
    ...
    public function testMultipleDifferentProductsOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
        $this->quotePreparer->addProduct($quote, 'simple-1', 2);
     ...
     * @magentoAppIsolation enabled
     */
    public function testProductIsTypePhysicalInOrderlineListOnDefaultLevelForShopSetup1()
    {
        $quote = $this->session->getQuote();
        $this->quotePreparer->addProduct($quote, 'simple', 1);
        ...
        $item = $this->prePurchaseValidator->getAllProductOrderlineItems($orderLines)[0];
